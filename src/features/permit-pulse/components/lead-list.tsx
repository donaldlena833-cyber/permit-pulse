      ...
      <div className="border-b border-navy-200/70 p-4 dark:border-dark-border/70">
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <div className="mt-1 text-sm leading-6 text-navy-500 dark:text-dark-muted">{description}</div>
          </div>
          <button
            className="rounded-full border border-navy-200 bg-cream-50 px-3 py-2 text-sm dark:border-dark-border dark:bg-dark-bg"
            onClick={onToggleAll}
            type="button"
          >
          ...
          {leads.map((lead, index) => {
            ...
            return (
              <button
                key={lead.id}
                className={cn(
                  "group w-full rounded-[26px] border p-4 text-left transition-all duration-200 hover:-translate-y-0.5 hover:border-orange-200 hover:shadow-sm dark:hover:border-orange-800/40",
                  isActive
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
                      <div className="min-w-0">
                        ...
                        <p className="mt-2 line-clamp-2 text-sm leading-6 text-navy-500 dark:text-dark-muted">
                          {lead.humanSummary}
                        </p>
                      </div>
                      <div className="text-left xl:text-right">
                        ...
                        <div className="mt-2 text-sm text-navy-500 dark:text-dark-muted">
                    ...
                    <div className="mt-4 grid gap-3 rounded-[22px] border border-navy-200/70 bg-white/70 p-3 dark:border-dark-border/70 dark:bg-dark-card/80">
                      ...
                      <div className="text-sm leading-6 text-navy-500 dark:text-dark-muted">
                        {lead.nextAction.label} — {lead.nextAction.detail}
                      </div>
                      <div className="flex flex-wrap items-center gap-4 text-xs uppercase tracking-[0.18em] text-navy-400 dark:text-dark-muted">
                        ...
                        <span className="inline-flex items-center gap-1">
                          ...
                          {lead.contactability.label} contactability
                        </span>
                      </div>
                    </div>
                  </div>
